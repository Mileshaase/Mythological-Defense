...
public class DialogueManagerForGodEncounters : MonoBehaviour
{
    ...
    */
	...
	[HideInInspector]
	public DialogueTriggerForGodEncounter currentTrigger;
	...
	private IEnumerator Wait()
	{
		...
		if(SceneManager.GetActiveScene().name == "GodEncounter1")
		{
			SceneManager.LoadScene("GameScene2");
		}
		else if(SceneManager.GetActiveScene().name == "GodEncounter2")
		{
			SceneManager.LoadScene("GameScene3");
		}
		else if(SceneManager.GetActiveScene().name == "GodEncounter3")
		{
